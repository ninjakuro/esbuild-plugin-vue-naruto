...
import { SFCTemplateCompileOptions, SFCScriptCompileOptions, SFCStyleCompileOptions } from 'vue/compiler-sfc'

export interface Options {
    // template
    templateOptions?: Pick<
        SFCTemplateCompileOptions,
        'compiler' | 'compilerOptions' | 'preprocessLang' | 'preprocessOptions' | 'transformAssetUrls'
    >
    ...
    styleOptions?: Pick<
        ...
        'preprocessLang' | 'preprocessOptions' | 'postcssOptions' | 'postcssPlugins' | 'trim'
    >
}
...
function plugin({ templateOptions, scriptOptions, styleOptions }: Options = {}): Plugin {
    return {
        name: 'vue',
        setup(build) {
            const { sourcemap: sourceMap } = build.initialOptions
